...
export default function App() {
  return (
    <View className="flex-1 items-center justify-center bg-background dark:bg-background-dark p-4">
      <Feather name="layout" size={48} className="text-primary dark:text-primary-dark mb-4" />
      <Text className="text-2xl font-bold text-foreground dark:text-foreground-dark mb-2">Component Library</Text>
